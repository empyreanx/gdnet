...
public:
	...
	void send_packet(const ByteArray& packet, int channel_id = 0, GDNetMessage::Type type = GDNetMessage::UNSEQUENCED);
	void send_var(const Variant& var, int channel_id = 0, GDNetMessage::Type type = GDNetMessage::UNSEQUENCED);
